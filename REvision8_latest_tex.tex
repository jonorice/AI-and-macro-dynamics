...
\begin{abstract}
Specialised AI hardware depreciates far faster than conventional capital -- GPUs become economically obsolete in roughly three years, compared with fifteen or more for traditional equipment. This paper embeds that distinction in a growth model with two capital stocks: ordinary plant and equipment alongside AI-related compute capacity. Because the economy is already replacing a large share of its AI hardware every quarter, even small misalignments between the actual and optimal stock can be corrected quickly by adjusting gross investment -- a mechanism that is absent from a passive depreciation-only benchmark. Calibrated to advanced economies in the mid-2020s, passive decay alone implies a half-life of about seven quarters for AI capacity versus roughly eleven years for conventional capital, helping rationalise the sharp boom-bust patterns visible in data-centre spending. Macro outcomes are highly sensitive to the rate at which AI hardware loses value: a two-percentage-point reduction in quarterly depreciation raises welfare by 0.36\% in consumption-equivalent terms, while an equal-sized compute tax shrinks the steady-state AI stock by around one-fifth. Policy tools that change effective hardware costs -- durability mandates, accelerated depreciation, compute levies -- therefore have direct, predictable effects on the AI capital stock and on consumption patterns.
\end{abstract}
